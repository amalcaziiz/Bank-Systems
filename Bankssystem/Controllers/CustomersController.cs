...
namespace Bankssystem.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            return View(await _context.TBL_Customer.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Email,PhoneNumber,DateOfBirth,CreatedAt")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Email,PhoneNumber,DateOfBirth,CreatedAt")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
